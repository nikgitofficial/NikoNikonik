...
const Sitemap = () => {
  const siteSections = [
    {
      title: "Main Pages",
      links: ["Home", "Dashboard", "Login", "Register", "Forgot Password", "Profile", "Settings"],
    },
    {
      title: "Resources",
      links: ["Docs", "Guides", "FAQ", "All Answers", "Blog", "Analytics", "Preview"],
    },
    {
      title: "Company",
    ...
    {
      title: "Legal",
      links: ["Privacy Policy", "Terms and Conditions", "Cookie Banner", "Cookie Settings", "Security"],
    },
  ];
